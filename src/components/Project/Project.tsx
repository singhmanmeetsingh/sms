      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/singhmanmeetsingh/esports" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>AI Sports Narrator</h3>
              <p>Developed real-time eSports commentary system using Django and GPT-4v for natural language generation. Implemented voice synthesis and comprehensive game analysis with automated statistical tracking and event detection.</p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/singhmanmeetsingh/spectraderm" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Spectraderm - Medical Image Analysis</h3>
              <p>Built machine learning system for skin disease classification achieving 90% accuracy. Implemented CNN architecture with TensorFlow/Keras for image processing and automated diagnostic suggestions.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/singhmanmeetsingh/CUBICASA" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>CubiCasa Floor Plan Analysis</h3>
              <p>Led architectural drawing analysis using deep learning on CUBICASA5K dataset. Developed CNN models for automated floor plan interpretation and spatial analysis with custom visualization tools.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Reddit Analysis Bot</h3>
              <p>Created data analysis system for Reddit content using Python and NLP. Implemented automated content categorization, sentiment analysis, and trend detection with interactive visualization dashboard.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
