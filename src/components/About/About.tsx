...
import ManmeetSingh from "../../assets/ManmeetSingh.jpg";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Manmeet Singh, a full-stack developer transitioning into the AI/ML field. With a passion for creating custom online experiences, I've honed my skills in Python, Typescript, Go, JavaScript, Django ,and React to bring your website vision to life.
          </p>
        </ScrollAnimation>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.20 * 1000}>
          <img src={ManmeetSingh} alt="Manmeet Singh" height={250} width={250} />
        </ScrollAnimation>
      </div>
    </Container>
  )
